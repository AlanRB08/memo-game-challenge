    ...
    <main className="relative flex h-screen overflow-hidden bg-background px-5 py-6 text-text-primary sm:px-6 sm:py-8">
      ...
      <section className="relative z-10 mx-auto flex w-full max-w-3xl flex-col items-center justify-center text-center">
        ...
        <button
          ...
          className="mt-12 inline-flex cursor-pointer items-center justify-center gap-3 rounded-full bg-yellow-300 px-8 py-4 text-base font-black uppercase tracking-[0.18em] text-slate-950 shadow-[0_0_30px_rgba(253,224,71,0.35)] transition-transform duration-200 hover:button-pop focus:outline-none focus:ring-4 focus:ring-yellow-200/60 sm:mt-14"
        >

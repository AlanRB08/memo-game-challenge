...
export function MemoryCard({
  ...
  return (
    <button
      ...
      className={`group relative aspect-square w-[clamp(4.5rem,22vw,8rem)] rounded-2xl [perspective:1000px] focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2 focus:ring-offset-background disabled:cursor-default sm:w-[clamp(6rem,14vw,10rem)] ${
